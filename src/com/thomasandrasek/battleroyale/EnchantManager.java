...
/*
    General manager for all the enchantments
 */

public class EnchantManager {

    /**
     * Opens the enchant buy menu
     * @param event the event of right clicking on an enchantment table
     */
    public static void openEnchantMenu(PlayerInteractEvent event)
    {
        Inventory inventory = Bukkit.createInventory(null, 27, ChatColor
                .translateAlternateColorCodes('&', "&d&lEpic Enchantments Sold Here OwO"));

        ItemStack ironSword = new ItemStack(Material.IRON_SWORD, 1);
        ItemMeta meta = ironSword.getItemMeta();
        meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',
                "&9&lSharpness I Cost: &65xp"));
    ...
    /**
     * Gives the player a sharpness book
     * @param event event of clicking on the sharpness book in the buy menu
     */
    ...
    /**
     * Gives the player a power I book
     * @param event event of clicking on the power book in the enchant menu
     */
    ...
    /**
     * Gives the player a protection book
     * @param event event of clicking on the protection book in the buy menu
     */
