        ...
        if(cmd.getName().equalsIgnoreCase("br"))
        {
            ...
            if(args[0].equalsIgnoreCase("mapchests"))
            {
                ...
                Location loc1 = new Location(
                        Bukkit.getWorld(Main.configManager.getArena().getString("arena." + "arena-" + args[1] + ".world-name")),
                    ...
                    public void run() {
                        ...
                        while(loop < 1000000)
                        {
                            ...
                            if(temp.getBlock().getType().equals(Material.CHEST)) {
                                chestsFound++;
                                Main.configManager.getArenaChest().set("arena." + "arena-" + args[1] + ".chest-count", chestsFound);

                                Main.configManager.getArenaChest().set("arena." + "arena-" + args[1] + ".chests.chest-" + (new Integer(chestsFound)).toString() + ".x", temp.getX());
                                Main.configManager.getArenaChest().set("arena." + "arena-" + args[1] + ".chests.chest-" + (new Integer(chestsFound)).toString() + ".y", temp.getY());
                                Main.configManager.getArenaChest().set("arena." + "arena-" + args[1] + ".chests.chest-" + (new Integer(chestsFound)).toString() + ".z", temp.getZ());
